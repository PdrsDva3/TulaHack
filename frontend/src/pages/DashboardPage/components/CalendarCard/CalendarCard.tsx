...
export const CalendarCard = () => {
	return(
		<Container
			sx={{display:'flex', flexDirection:'column', gap:2, backgroundColor:'common.white', borderRadius:'20px',height:"28.75vw", width:"27.778vw", alignItems:'center', justifyContent:"space-between"}}
		>
			<Box
				sx={{pb:16}}
			>
