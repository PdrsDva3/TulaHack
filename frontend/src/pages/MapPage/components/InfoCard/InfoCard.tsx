...
export const InfoCard = () => {
	return(
		...
		>
			...
			<Box className="coordinates_field"
				sx={{display:"flex", justifyContent:"space-between"}}
			>
				<Typography variant="h4">
					Координаты:
			...
			<Box className="bot_messege_field"
			...
			<Box className="container_field" >
				...
				<Divider
					...
					sx={{width:"25vw", color:"primary", py:1}}

				/>
				<Box sx={{display:'flex', justifyContent:"space-around"}}>
					<Typography variant="h6" color="secondary.dark">5</Typography>
					<Typography variant="h6" color="secondary.dark">стандартный</Typography>
					<Typography variant="h6" color="secondary.dark">в работе</Typography>
				</Box>
			</Box>
		</Container>
	)
